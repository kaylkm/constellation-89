...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!await db.CapsulePrices.AnyAsync())
    {
        db.CapsulePrices.AddRange(
            new CapsulePrice { Slug = "single",  Price = 890  },
            new CapsulePrice { Slug = "singlew", Price = 1390 },
            new CapsulePrice { Slug = "singlem", Price = 2190 },
            new CapsulePrice { Slug = "double",  Price = 2190 }
        );
